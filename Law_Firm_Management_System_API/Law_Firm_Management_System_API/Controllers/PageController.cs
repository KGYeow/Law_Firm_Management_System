...
namespace Law_Firm_Management_System_API.Controllers
{
    ...
    {
        public PageController(IConfiguration configuration, UserService userService, Law_Firm_Management_System_DBContext context) : base(configuration, userService, context)
        {
        }

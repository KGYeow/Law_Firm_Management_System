        ...
        <div class="hstack justify-content-center align-items-stretch">
          ...
          <div class="p-4 w-75">
            ...
            <v-card-item>
              ...
              <v-row>
                <v-col cols="3" class="d-flex align-center">
                  <v-label class="text-h6 pb-3">Assigned Paralegal</v-label>
                </v-col>
                <v-col>
                  <v-card-subtitle class="p-0">
                    <a :href="`/contacts/paralegals/${partnerInfo.assignedParalegalUserId}`" target="_blank" class="text-secondary" v-if="partnerInfo.assignedParalegalUserId && userRole == 'Partner'">
                      {{ partnerInfo.assignedParalegal }}
                    </a>
                    <span v-else-if="partnerInfo.assignedParalegalUserId && userRole == 'Paralegal'">{{ partnerInfo.assignedParalegal }}</span>
                    <span v-else>-</span>
                  </v-card-subtitle>
                </v-col>
              </v-row>

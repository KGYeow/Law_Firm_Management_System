    ...
    <v-card-item>
      ...
      <v-row>
        <v-col cols="12" sm="12">
          ...
          <div class="d-flex align-center flex-shrink-0" v-if="eventTotal != 0">
            <apexchart type="donut" height="145" :options="chartOptions" :series="chartSeries"/>
          </div>
          <el-empty class="p-0 pb-2" :image-size="110" description="No event" v-else/>
        </v-col>
        <v-col cols="12" sm="12" v-if="eventTotal != 0">
